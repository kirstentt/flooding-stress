...
CH2O_l 	 = NaN(len*RunTime,length(CanopyArea)*length(RootDepth)*length(ROLB_on_off));
...
%%Plotting
figure(1)
plot(RootDepth,survive(1:8),'x-k','MarkerSize',12)
hold on
plot(RootDepth,survive(9:16),'o-k')
hold on
plot(RootDepth,survive(17:24),'x-r','MarkerSize',12)
hold on
plot(RootDepth,survive(25:32),'o-r')
hold on
plot(RootDepth,survive(33:40),'x-b','MarkerSize',12)
hold on
plot(RootDepth,survive(41:48),'o-b')
hold on
plot(RootDepth,survive(49:56),'x-g','MarkerSize',12)
hold on
plot(RootDepth,survive(57:64),'o-g')
hold on
plot(RootDepth,survive(65:72),'x-m','MarkerSize',12)
hold on
plot(RootDepth,survive(73:80),'o-m')
xlabel('Root depth (m)');
